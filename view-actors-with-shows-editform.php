...
<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#editEpisodesModal<?php echo $course['episode_id'];?>">
...
<!-- Modal -->
<div class="modal fade" id="editEpisodesModal<?php echo $course['episode_id'];?>" tabindex="-1" aria-labelledby="editEpisodesModalLabel<?php echo $course['episode_id'];?>" aria-hidden="true">
